...
import { createGallery, imageUpload, videoGalleryCreate } from "@/services/operation/admin";

function VideoGalleryCreate() {
...
export default VideoGalleryCreate;
